...
export default function RebuiltSettingsPage() {
  ...
  return (
    <div className="space-y-6 pb-24 font-sans text-slate-900">
      ...
      {/* Sub-Nav Tabs (Horizontal Bar on Desktop & Mobile) */}
      <div className="flex bg-slate-100 p-1.5 rounded-2xl border border-slate-200/80 overflow-x-auto no-scrollbar gap-1 text-xs font-bold text-slate-600">
        <button

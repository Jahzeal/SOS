    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 min-h-screen">
        ...
        <div className="w-full lg:col-span-7 p-4 sm:p-6 lg:p-8 xl:p-12 2xl:p-16 flex flex-col justify-between bg-slate-50 min-h-screen relative overflow-hidden">
          ...
          {/* Header & Stepper Bar */}
          <div className={`${currentStep === 4 ? 'max-w-6xl 2xl:max-w-7xl' : 'max-w-2xl xl:max-w-3xl 2xl:max-w-4xl'} mx-auto w-full space-y-3 sm:space-y-4 xl:space-y-5 transition-all duration-300`}>
            ...
            <div className="hidden lg:flex items-center justify-between border-b border-slate-200 pb-3">
              <button
                onClick={handleBack}
              ...
              {[
                ...
                return (
                  <div key={s.step} className="space-y-1.5 text-center">
                    <div
                      className={`h-1.5 xl:h-2 rounded-full transition-all duration-300 ${
                        isCompleted
                          ? 'bg-emerald-500'
                          : isCurrent
          ...
          {/* Main Card Content */}
          <div className={`${currentStep === 4 ? 'max-w-6xl 2xl:max-w-7xl' : 'max-w-2xl xl:max-w-3xl 2xl:max-w-4xl'} mx-auto w-full my-2 sm:my-3 xl:my-4`}>
            <div className={`vf-card bg-white ${currentStep === 4 ? 'p-4 sm:p-5 lg:p-6 space-y-3.5 sm:space-y-4' : 'p-5 sm:p-8 lg:p-10 xl:p-12 2xl:p-14 space-y-6 xl:space-y-8'} rounded-2xl xl:rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50`}>
              ...
              {currentStep === 4 && (
                <div className="space-y-3.5 sm:space-y-4 animate-in fade-in duration-200">
                  ...
                  {viewingPlanDetails ? (
                    ...
                    <div className="p-4 sm:p-6 rounded-2xl bg-white border border-slate-200 shadow-md space-y-4 animate-in zoom-in duration-200">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <button
                          type="button"
                          onClick={() => setViewingPlanDetails(null)}
                          className="inline-flex items-center gap-1.5 text-xs font-extrabold text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200/80 px-3 py-1.5 rounded-lg transition cursor-pointer"
                        >
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 sm:p-5 rounded-xl bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-white shadow-sm">
                        <div className="space-y-1">
                        ...
                        <div className="p-3 sm:p-4 rounded-xl bg-white/10 border border-white/10 text-right shrink-0">
                      ...
                      <div className="space-y-2.5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs text-slate-700">
                          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start gap-2.5">
                            <div className="p-1.5 rounded-md bg-teal-50 text-teal-700 shrink-0">
                          ...
                          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start gap-2.5">
                            ...
                            <div>
                              <div className="font-bold text-slate-900 text-xs sm:text-sm">Thermal Receipts & QR Origin</div>
                              <p className="text-[11px] text-slate-500 mt-0.5">
                          ...
                          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start gap-2.5">
                            ...
                            <div>
                              <div className="font-bold text-slate-900 text-xs sm:text-sm">Anti-Theft IMEI Blacklist Check</div>
                              <p className="text-[11px] text-slate-500 mt-0.5">
                                Cross-check incoming swap phones against national registries.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start gap-2.5">
                            ...
                            <div>
                              <div className="font-bold text-slate-900 text-xs sm:text-sm">Store Staff & Branch Access</div>
                              <p className="text-[11px] text-slate-500 mt-0.5">
                                Granular permissions for cashiers, reps, and repair techs.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-3">
                        <button
                          type="button"
                          onClick={() => setViewingPlanDetails(null)}
                          className="px-3.5 py-2 rounded-lg border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-50 transition cursor-pointer"
                        >
                          ← Back to All Plans
                        </button>
                        ...
                        <button
                          ...
                          className="px-5 py-2 rounded-lg bg-teal-600 hover:bg-teal-500 text-white text-xs font-extrabold shadow-sm transition flex items-center gap-1.5 cursor-pointer"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2.5 sm:gap-3">
                      {dynamicPlans.length > 0 ? (
                        dynamicPlans.map((planItem) => {
                          ...
                          return (
                            <div
                              ...
                              className={`p-3.5 sm:p-4 rounded-xl sm:rounded-2xl border cursor-pointer transition-all relative flex flex-col justify-between space-y-2.5 ${
                                isSelected
                                  ? 'border-teal-600 bg-teal-50/25 ring-2 ring-teal-500/20 shadow-md'
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="space-y-1.5 pt-2 border-t border-slate-100 text-[11px] font-medium text-slate-700">
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    <Check className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
                                    <span className="truncate">IMEI Ledger & QR Codes</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-1.5 pt-2 border-t border-slate-100">
                                <button
                                  ...
                                  className="w-full text-center text-[10px] font-bold text-teal-600 hover:text-teal-700 hover:underline flex items-center justify-center gap-0.5 cursor-pointer"
                                >
                                ...
                                <div
                                  className={`py-1.5 px-2 rounded-lg text-center text-xs font-bold transition ${
                        ...
                        <div className="col-span-full p-6 rounded-xl bg-white border border-slate-200 text-center space-y-1">
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-4">
                ...
                <Button
                  ...
                  className="shadow-md bg-teal-600 hover:bg-teal-500 font-bold text-xs sm:text-sm py-2.5 sm:py-3 px-5 sm:px-7 rounded-xl ml-auto"
                >
          ...
          <div className={`${currentStep === 4 ? 'max-w-6xl 2xl:max-w-7xl' : 'max-w-2xl xl:max-w-3xl 2xl:max-w-4xl'} mx-auto w-full text-center text-xs xl:text-sm font-medium text-slate-500 pb-4 lg:pb-0`}>
